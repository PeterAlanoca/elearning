                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <div class="thumbnail">
                            <%
                                ...
                                Estudiante est = estudianteModel.getId(idperfil);
                                
                            %>
                            <h4 style="color:#902654; "><%="ESTUDIANTE: "+est.getNombre().toUpperCase()+" "+est.getPaterno().toUpperCase()+" "+est.getMaterno().toUpperCase()%></h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="margin-left:30px; color:#902654; ">
                                            <h4><span class="fa fa-envelope"></span> <%=est.getCorreo()%></h4>
                                            <h4><span class="fa fa-phone-square"></span> <%=est.getCelular()%></h4>
                                            <h4><span class="glyphicon glyphicon-book"></span> <%=est.getMateria()%></h4>
                                        </div>
                                    </td>
                                </tr>
                            </table>
