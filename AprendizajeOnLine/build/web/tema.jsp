                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="thumbnail">
                            <%
                                ...
                                Tema tema = temaModel.getId(idtema);        
                            %>
                            <h4 style="color:#902654; "><%=tema.getTitulo().toUpperCase()%></h4>
                            <div style="margin-left:30px">
                                <h5 style="color:#902654;"><i class="glyphicon glyphicon-book"></i> <%=tema.getDescripcion()%></h5>
                                <h5 style="color:#902654;"><i class="glyphicon glyphicon-time"></i> <%=tema.getFecha()%></h5>
                                <p style="color:#902654; text-align: justify;"><%=tema.getContenido()%></p>
                                <a href="<%=base_url+"web/files/"+tema.getArchivo()%>" class="btn btn-success" download>
