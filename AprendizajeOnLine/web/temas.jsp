...
<body>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        <div class="thumbnail">
                            <div class="row">
                                <div class="col-md-9">
                                    <h4 style="color:#902654">TEMAS AVANZADOS</h4>
                                </div>
                                <div class="col-md-3">
                                    <%
                                        if(docente != null){
                                    %>
                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-tema">
                                        AGREGAR TEMA
                                    </button>
                                    <%
                                        }
                            ...
                            <%
                                for(Tema tema: AuxTemas){
                            %>
                            <div class="alert alert-danger" role="alert" >
                                <h4 style="color:#902654"><a style="text-decoration:none; color:#902654" href="tema.jsp?id=<%=tema.getId()%>"><span class="glyphicon glyphicon-book"></span> <%=tema.getTitulo()%></a></h4>
                                <p style="margin-left:30px"><span class="glyphicon glyphicon-info-sign"></span> <%=tema.getDescripcion()%></p>
                                <p style="margin-left:30px"><span class="glyphicon glyphicon-calendar"></span> 23/11/2016</p>
                                <a style="margin-left:30px;text-decoration:none; color:#902654" href="<%=base_url+"web/files/"+tema.getArchivo()%>" download><span class="glyphicon glyphicon-file"></span> Archivo adjunto</a>
                            </div>
                            <%
                                }
                            %>                         
    ...
    <!-- Modal -->
    <div class="modal fade" id="modal-tema" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="form1" method="post" action="Temas" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="titulo" id="titulo" class="form-control"  placeholder="Título del tema">
                    </div>
                    <div class="form-group">
                        <label for="descripcion">Descripción</label>
                        <input type="text" name="descripcion" id="descripcion" class="form-control"  placeholder="Descripción del tema">
                    </div>
                    <div class="form-group">
                        <label for="contenido">Contenido</label>
                        <textarea rows="4" name="contenido" id="contenido" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="archivo">Archivo</label>
                        <input type="file" class="file" name="archivo" id="archivo" data-min-file-count="1" accept="application/pdf">
                        <script>
                            $("#archivo").fileinput({
                                showUpload: false,
                                showZoom: false,
